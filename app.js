...
- Aktuell: ${d.intervention}.`,
      epikrise: `${d.patient} wurde zur elektiv geplanten Koronarangiographie stationär aufgenommen. Koronarangiographisch imponierte eine koronare ${d.vesselDisease}-Gefäßerkrankung mit hochgradiger ${d.lesion}, welche in gleicher Sitzung mittels ${d.intervention} komplikationslos versorgt wurde. Der postinterventionelle Verlauf gestaltete sich unauffällig. Aufgrund der Stentimplantation empfehlen wir eine duale Thrombozytenaggregationshemmung mit ASS und ${d.p2y12} für ${d.daptMonths} Monate, anschließend eine lebensbegleitende Monotherapie. Die punktierte ${d.access} präsentierte sich am Entlasstag inspektorisch und palpatorisch reizlos bei intakter peripherer Durchblutung, Sensibilität und Motorik. Wir entlassen den Patienten am ${d.date} in stabilem und beschwerdefreiem Allgemeinzustand in die weitere ambulante fachärztliche Betreuung.`,
      procedere: `- DAPT mit ASS und ${d.p2y12} für ${d.daptMonths} Monate, anschließend Monotherapie
...
- Echokardiographische Verlaufskontrollen`
  ...
  },
  {
    ...
    build: (d) => ({
      ...
      epikrise: `${d.patient} wurde bei kardialer Dekompensation mit Dyspnoe stationär aufgenommen. Klinisch sowie radiologisch imponierten kardiale Stauungszeichen. Das NT-pro-BNP lag bei ${d.ntprobnp}. Unter ${d.diuresis} konnte eine deutliche Beschwerdebesserung mit suffizienter Negativbilanz erzielt werden (insgesamt mobilisiert: ${d.weight}). Echokardiographisch zeigte sich ${d.echo}. Die ${d.troponin}. Wir empfehlen im Verlauf tägliche Gewichtskontrollen sowie eine Trinkmengenbegrenzung. Entlassung am ${d.date} in stabilem Allgemeinzustand in die ambulante Weiterbehandlung.`,
...
- Ausreizen der leitliniengerechten Herzinsuffizienztherapie`
  ...
  },
  {
    ...
    build: (d) => ({
      ...
      epikrise: `${d.patient} wurde bei erstmalig diagnostiziertem tachyarrhythmischem Vorhofflimmern stationär aufgenommen. Bei einem CHA2DS2-VASc-Score von ${d.chadsvasc} wurde eine orale Antikoagulation mit ${d.oak} begonnen. Im Langzeit-EKG zeigte sich ${d.lzekg}. Echokardiographisch ergab sich ein strukturelles Korrelat der Rhythmusstörung. Im weiteren Verlauf wurde eine ${d.strategy} etabliert; ${d.cardioversion}. Zur Rhythmusstabilisierung erfolgte ${d.amio}. Wir empfehlen eine engmaschige rhythmologische Nachsorge. Entlassung am ${d.date} in gutem Allgemeinzustand in die ambulante Weiterbehandlung.`,
...
- Aktuell: ${d.result}e elektrische Kardioversion mit ${d.joule}.`,
        epikrise: `${d.patient} stellte sich mit symptomatischem ${d.arrhythmia} stationär vor. Nach Ausschluss intracavitärer Thromben in einer transösophagealen Echokardiographie erfolgte ${d.result === "erfolgreich" ? "komplikationslos" : "unter adäquatem Schockprotokoll"} die elektrische Kardioversion mit ${d.joule}. Im weiteren Verlauf zeigte sich ${d.result === "erfolgreich" ? "anhaltend ein normfrequenter Sinusrhythmus" : "persistierend Vorhofflimmern"}. Bei einem CHA2DS2-VASc-Score von ${d.chadsvasc} ist eine orale Antikoagulation ${oakDuration} indiziert. Wir entlassen den Patienten am ${d.date} in stabilem Allgemeinzustand in die weitere fachärztliche Betreuung.`,
...
- Rhythmologische Wiedervorstellung in der Sprechstunde`
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "result", label: "Ergebnis", type: "text", default: "erfolgreicher Isolation aller Pulmonalvenen" },
    ...
    build: (d) => {
      ...
      const ppiSentence = d.method === "Pulsed Field Ablation"
        ? ""
        : " Ergänzend ist eine PPI-Therapie in doppelter Standarddosis für vier Wochen nach PVI zu empfehlen.";
      const dischargeTitle = d.patientTitle === "Herr" ? "Herrn" : "Frau";
...
- Aktuell: erfolgreiche Pulmonalvenenisolation mittels ${d.method}.`,
        epikrise: `${d.patientTitle} ${d.patient} stellte sich mit symptomatischem ${d.afType.toLowerCase()}em Vorhofflimmern stationär vor. Nach dem Ausschluss intracavitärer Thromben in einer transösophagealen Echokardiographie erfolgte komplikationslos die elektrophysiologische Untersuchung mit ${d.result} mittels ${d.method}. Der weitere Aufenthalt gestaltete sich unauffällig, in seriellen echokardiographischen Kontrollen konnte postinterventionell ein Perikarderguss ausgeschlossen werden. Bei einem CHA2DS2-VASc-Score von ${d.chadsvasc} ist eine orale Antikoagulation ${oakDuration} indiziert.${ppiSentence} ${groinSentence} Wir entlassen ${dischargeTitle} ${d.patient} am ${d.date} in gutem Allgemeinzustand in sein/ihr häusliches Umfeld und die weitere fachärztliche Betreuung.`,
  ...
  },
  {
    ...
    build: (d) => {
      ...
      return {
        diagnosen: `${d.entity}.
- Aktuell: ${d.procedure}.`,
        epikrise: `${d.patient} wurde mit symptomatischen paroxysmalen Tachykardien stationär aufgenommen. Es erfolgte komplikationslos die elektrophysiologische Untersuchung mit ${d.procedure}. Der weitere Verlauf gestaltete sich unauffällig; in der postinterventionellen echokardiographischen Kontrolle zeigte sich kein Perikarderguss. Die Punktionsstelle war am Entlasstag ${d.groin}. Wir entlassen den Patienten am ${d.date} in stabilem Allgemeinzustand in die weitere ambulante Betreuung.`,
